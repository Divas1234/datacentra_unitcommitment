...
# Read the CSV file
data <- read.csv("d:/GithubClonefiles/datacentra_unitcommitment/output/data_centra/dc_fv².csv")
...
ggsave(plot = p, width = 8, height = 10, dpi = 300, filename = "d:/GithubClonefiles/datacentra_unitcommitment/output/data_centra/stacked_dc_fv²_subplots.pdf")
