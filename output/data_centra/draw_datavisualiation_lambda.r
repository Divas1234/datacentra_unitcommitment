...
# Read the CSV file
data <- read.csv("d://GithubClonefiles//datacentra_unitcommitment//output//data_centra//dc_Δu1.csv")
...
ggsave(plot = q, width = 8, height = 4, dpi = 300, filename = "d://GithubClonefiles//datacentra_unitcommitment//output//data_centra//stacked_dcc_dc_Δu1_plot.pdf")