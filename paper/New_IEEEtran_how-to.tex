...
Despite these constraints, these constraints (3a)-(3d) remain elusive due to the presence of product terms involving continuous variables $\phi_{dcc,i}^{dvfs}$ and $\varDelta \lambda_{dcc,i}$ in (3a), therefore, the McCormick Envelope method is introduced to linear the constructed constraints mentioned before. More detailed, 
